...
exports.middlewareInventory = {
    ...
    getInventory: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var idSucursal, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idSucursal = req.params.idSucursal;
                    return [4 /*yield*/, network_1.callSPWithCallback('Call IVN_llenarTabla_inventario(?)', idSucursal)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
                            .catch(function (err) { return responseBody_1.ResponseBodyBuilder(500, true, err); })];
                case 1:
                    response = _a.sent();
    ...
    insertProductIntoInventory: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var newinventoryProduct, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    newinventoryProduct = req.body;
                    return [4 /*yield*/, network_1.callSPWithCallback('Call IVN_consultaRegistrarProductoInventario(?,?,?,?,?,?,?,?,?,?,?,?,?)', newinventoryProduct)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
                            .catch(function (err) { return responseBody_1.ResponseBodyBuilder(500, true, err); })];
                case 1:
                    response = _a.sent();
    ...
    registerDeletedProduct: function (req) { return __awaiter(void 0, void 0, void 0, function () {
