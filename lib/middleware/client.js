...
var clientMiddleware = {
    getClients: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var idSucursal, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idSucursal = req.params.idSucursal;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call CLI_llenarTabla_Cliente(?)", idSucursal)
    ...
    createNewClient: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var bodyCereateNewClient, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bodyCereateNewClient = req.body;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call CLI_registrarCliente(?,?,?,?,?,?,?,?,?)", bodyCereateNewClient.idSucursal, bodyCereateNewClient.nombre, bodyCereateNewClient.apellido, bodyCereateNewClient.telefono, bodyCereateNewClient.direccion, bodyCereateNewClient.mail, bodyCereateNewClient.id_ciudad, bodyCereateNewClient.id_usuario, bodyCereateNewClient.iden, bodyCereateNewClient.tipoCliente, bodyCereateNewClient.declaraIva, bodyCereateNewClient.declaraIca, bodyCereateNewClient.reteFuente, bodyCereateNewClient.milesIca, bodyCereateNewClient.dv)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
    ...
    updateClient: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var idClient, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idClient = req.params.idClient;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call CLI_eliminar_Cliente(?, ?, ? , ?, ? , ?, ?)", req)
                            .then(function (response) {
                            if (response) {
                                return responseBody_1.ResponseBodyBuilder(200, false, !!response);
                            }
