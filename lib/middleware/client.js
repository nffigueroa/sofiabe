...
var clientMiddleware = {
    getClients: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    createNewClient: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var bodyCereateNewClient, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bodyCereateNewClient = req.body;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call CLI_registrarCliente(?)", bodyCereateNewClient)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
    ...
    deleteClient: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    updateClient: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var idClient, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
