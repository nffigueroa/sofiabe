...
exports.middlewareProvider = {
    getProviders: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var idSucursal, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idSucursal = req.params.idSucursal;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call PRO_consultaLlenarTablaProveedor(?)", idSucursal)
    ...
    insertProvider: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var idSucursal, newProvider, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idSucursal = req.params.idSucursal;
                    newProvider = req.body;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call PRO_consultaLlenarTablaProveedor(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", newProvider)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
                            .catch(function (err) { return responseBody_1.ResponseBodyBuilder(500, true, err); })];
                case 1:
                    response = _a.sent();
    ...
    updateProvider: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        var idSucursal, provider, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    idSucursal = req.params.idSucursal;
                    provider = req.body;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call GEN_consultaModificarProveedor(?,?,?,?,?,?,?,?)", provider)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
                            .catch(function (err) { return responseBody_1.ResponseBodyBuilder(500, true, err); })];
                case 1:
                    response = _a.sent();
    ...
    getProviderCategories: function (req) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    deleteProvider: function (req) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id_proveedor = req.params.id_proveedor;
                    return [4 /*yield*/, network_1.callSPWithCallback("Call GEN_eliminar_proveedor(?)", id_proveedor)
                            .then(function (response) { return responseBody_1.ResponseBodyBuilder(200, false, response); })
                            .catch(function (err) { return responseBody_1.ResponseBodyBuilder(500, true, err); })];
                case 1:
                    response = _a.sent();
