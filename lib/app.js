...
/** Provider API */
app.get("/" + const_1.API_VERSION + "/provider/:idSucursal", function (req, res, next) {
...
/*Product API*/
app.get("/" + const_1.API_VERSION + "/product/:idSucursal", function (req, res, next) {
    return middleware_1.Response(req, res, next, product_1.default.getProducts);
});
app.post("/" + const_1.API_VERSION + "/product/:idSucursal", function (req, res, next) {
...
/** Client API */
app.get("/" + const_1.API_VERSION + "/client/:idSucursal", function (req, res, next) {
...
app.post("/" + const_1.API_VERSION + "/auth", function (req, res, next) {
    return middleware_1.Response(req, res, next, user_1.default.loginProcess);
});
/** Category API */
...
app.get("/" + const_1.API_VERSION + "/other/company/sucursal/:idEmpresa", function (req, res, next) {
